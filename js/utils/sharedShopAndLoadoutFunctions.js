...
const filterItemsByWarbond = async (uploadingSaveData = null) => {
  ...
  // Update the toggle all button state
  if (typeof updateToggleAllButton === "function") {
    updateToggleAllButton();
  }
...
const generateSESItemCard = () => {
  ...
  card.className = `card col-2 col-lg-1 text-center d-flex align-items-center bbShopItemCards pcItemCards bbItemCards none`;
  card.innerHTML = `
  <img class="img-fluid pt-1 img-card-top" style='max-width: 60px;' src="../images/iconSVGs/dice.svg" />
